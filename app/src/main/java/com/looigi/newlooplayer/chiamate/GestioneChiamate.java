...
public abstract class GestioneChiamate extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.getInstance().ScriveLog("onReceive Gestione chiamate");
    ...
    public class PhonecallStartEndDetector extends PhoneStateListener {
        ...
        public void setOutgoingNumber(String number){
            Log.getInstance().ScriveLog("setOutgoing number");
        	try {
                savedNumber = number;
        	} catch (Exception e) {
                Log.getInstance().ScriveLog(e.getMessage());
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            Log.getInstance().ScriveLog("onCallStateChanged Gestione Chiamate");
            try {
                if(lastState == state){
                ...
                switch (state) {
                    case TelephonyManager.CALL_STATE_RINGING:
                        Log.getInstance().ScriveLog("onCallStateChanged: CALL STATE RINGING");
                        isIncoming = true;
                    ...
                    case TelephonyManager.CALL_STATE_OFFHOOK:
                        Log.getInstance().ScriveLog("onCallStateChanged: CALL STATE OFFHOOK");
                    ...
                    case TelephonyManager.CALL_STATE_IDLE:
                        Log.getInstance().ScriveLog("onCallStateChanged: CALL STATE IDLE");
